...
function first(givenUrl,callback){
...
function third(callback){
    ...
    async.forEachOf(allResults, function(value, key, callback) {
                    request(allResults[key],function(error, response,body){
                            ...
                            console.log("newPrice : ",newPrice," and sum is " ,sum);
                            callback(null);
                            });
                    ...
                    if(price>(sum/newPrices.length))
                    {	
                    	callback("the average price is :"+Math.round(sum/newPrices.length)+ "€ and I think that's not a good Deal!");
                    	sum=0;
                    }
                    else
                    {
                    	callback("the average price is :"+Math.round(sum/newPrices.length)+ "€ and I think that's a good Deal!");
                    	sum=0;
                    }
                    }
                    });
